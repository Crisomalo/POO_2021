...
public class Salida extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setPreferredSize(new java.awt.Dimension(1000, 339));

        panelSalida.setBackground(new java.awt.Color(255, 255, 255));
        panelSalida.setMinimumSize(new java.awt.Dimension(664, 339));
        ...
        panelSalida.add(imgUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(29, 11, -1, -1));

        txtSalida.setFont(new java.awt.Font("Calibri", 1, 24)); // NOI18N
        txtSalida.setText("Salida");
        panelSalida.add(txtSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, -1, -1));

        iconSalida.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images_origin/salida.png"))); // NOI18N
        panelSalida.add(iconSalida, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 160, -1, -1));
        ...
        panelSalida.add(buttonLimpiarCampos, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 280, -1, -1));

        txtUsuario.setBackground(new java.awt.Color(255, 255, 255));
        txtUsuario.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 0, 0)));
        panelSalida.add(txtUsuario, new org.netbeans.lib.awtextra.AbsoluteConstraints(69, 11, 160, 30));
        ...
        panelSalida.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 330, 680, 90));
        ...
        panelSalida.add(buttonRegresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(880, 440, -1, -1));

        txtCodigo.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        txtCodigo.setText("Codigo:");
        panelSalida.add(txtCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 110, -1, -1));

        txtNombre.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        txtNombre.setText("Nombre: ");
        panelSalida.add(txtNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 70, -1, -1));
        ...
        panelSalida.add(buttonEntregar, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 280, -1, -1));
        panelSalida.add(setCodigo, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 100, 250, 30));
        ...
        panelSalida.add(setNombre, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 60, 250, 30));

        txtEntregado.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        txtEntregado.setText("Entregado a :");
        panelSalida.add(txtEntregado, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 150, -1, -1));

        setEntregado.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                setEntregadoActionPerformed(evt);
            }
        });
        panelSalida.add(setEntregado, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 140, 250, 30));

        txtCantidad.setFont(new java.awt.Font("Calibri", 1, 18)); // NOI18N
        txtCantidad.setText("Cantidad:");
        panelSalida.add(txtCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 190, -1, -1));
        ...
        panelSalida.add(setCantidad, new org.netbeans.lib.awtextra.AbsoluteConstraints(400, 180, 250, 30));
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                ...
                .addComponent(panelSalida, javax.swing.GroupLayout.PREFERRED_SIZE, 1000, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
        layout.setVerticalGroup(
            layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                .addGap(0, 0, Short.MAX_VALUE)
                .addComponent(panelSalida, javax.swing.GroupLayout.PREFERRED_SIZE, 488, javax.swing.GroupLayout.PREFERRED_SIZE))
        );
    ...
    private void setEntregadoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_setEntregadoActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_setEntregadoActionPerformed
